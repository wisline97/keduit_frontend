...
app.get("/main", function (req, res) {
  res.render("0300_main_array.ejs"); // res.render() 는 ejs 파일을 출력한다.
});

app.get("/array01", function (req, res) {
  res.render("0301_array_test.ejs");
});
app.get("/array01Pro", function (req, res) {
  res.render("0301_array_testPro.ejs");
});

app.get("/array02", function (req, res) {
  res.render("0302_array_test.ejs");
});
app.get("/array02Pro", function (req, res) {
  res.render("0302_array_testPro.ejs");
});

app.get("/array03", function (req, res) {
  res.render("0303_array_test.ejs");
});
app.get("/array03Pro", function (req, res) {
  res.render("0303_array_testPro.ejs");
});
