...
#[개념 2-1](열이 한 개인 경우)DISTINCT로 중복데이터 제거하기
#[실습 2-1] 중복 데이터 없이 부서번호만 출력하기
select distinct DEPTNO
	from emp;

#[개념 2-2] (열이 여러 개인 경우)DISTINCT로 열 중복데이터 제거하기
#[실습 2-2] 중복 데이터 없이 직책과 부서번호 출력하기
...
/*	(1) 정의
	...
	(2) 별칭을 사용할때 쌍따옴표가 없이 사용하면 대문자로 표시되고, 
...
select *
    ...
    #ASC -> 오름차순(가장 작은 숫자가 위에서 가장 큰 숫자가 아래로)
...
select *
    ...
    #desc -> 내림차순(가장 큰 숫자가 위에서 가장 작은 숫자가 아래로)
